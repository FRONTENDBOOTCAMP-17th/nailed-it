...
![COMMON-PAGE](images/screenshots/common.png)

### 관리자 — 홈 / 문제 목록 / 문제 등록 / 문제 상세 / 문제 수정

![ADMIN-PAGE](images/screenshots/admin.png)

### 사용자 — 홈(로그인 후) / 카테고리 선택 / 퀴즈 풀이 과정

![USER-PAGE01](images/screenshots/user01.png)

### 사용자 — 즉시 피드백 (정답, 오답, 스킵) / 결과 / 히스토리

![USER-PAGE02](images/screenshots/user02.png)
